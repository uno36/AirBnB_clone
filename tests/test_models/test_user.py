...
class TestUser(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.model1.last_name = "ALX"
        self.model1.email = "airbnb@alxshool.com"
        ...
        self.model2.email = "airbnb2@alxshool.com"
    ...
    def test_new_attr_name(self):
        ...
        """model1.name is "ALX"
        """
        self.assertEqual(self.model1.name, "ALX")
    ...
    def test_last_name(self):
        ...
        self.assertEqual(self.model1.last_name, "ALX")

    def test_email(self):
        """ test user model email """
        self.assertEqual(self.model1.email, "airbnb@alxshool.com")
